...
class EmailService {
    ...
    static async sendPaymentReminder(email, fullName, groupName, amount, dueDate) {
    ...
    static async sendPayoutNotification(email, fullName, amount, groupName) {
    ...
    static async sendEmailVerification(email, fullName, verificationCode) {
